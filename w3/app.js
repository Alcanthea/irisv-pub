...
// FUnction 2 used to get emailCheck.

let emailTime = function (emailCheck) {
    let timeForEmail = 10
    
    if(timeForEmail = timeForEmail) {
       return `It is ${emailCheck} a.m. Alright time to check on emails. Lets Go! Once done I will take my lunch.`
    }

}
let resultTwo = emailTime(10)
showOnPage(resultTwo)
